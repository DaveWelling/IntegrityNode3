angular.module('workitemTreeModule')
    .directive('workitemTree', function(){
        return {
            restrict: 'E',
            templateUrl: './src/workitemTreeModule/treeTemplate.html'
        }
    })
                ...
                for (index = 0, length = collectionKeys.length; index < length; index++) {
                    ...
                    if (!block.startNode) {
                        linker(childScope, function(clone) {
                            clone[clone.length + 1] = document.createComment(' end ngRepeat: ' + expression + ' ');
